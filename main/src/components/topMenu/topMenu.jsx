...
import './topMenu.css';
import { ChevronDown, ShoppingBasket, ShoppingCart } from 'lucide-react';
	...
	return (
        <>
            <div className="logo-container">
                <Link to="/" className="topmenu-logo">
                    <h2 className='topmenu-logo-text'>The Zoo™</h2>
                </Link>
            </div>
            <div className="user-menu-container">
                <Link to="/portal/cart" className="user-menu-link shopping-cart-btn"><Button variant="brown" size="sm">
                    <ShoppingCart size={16} style={{ marginRight: '0.2rem' }} />
                ...
                <div className="user-menu" >
                    ...
                    {isOpen && (
                        <ul onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                            ...
                            <Link to="/portal" className="user-menu-link"><li>Portal Home</li></Link>
