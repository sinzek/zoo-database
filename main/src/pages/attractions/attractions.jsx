        ...
        setAttractions([
          {
            ...
            uiDescription: "Guided ride through open-range habitats with live narration.",
            location: "Main Zoo",
          },
          {
            attractionId: '2',
            ...
            uiDescription: "Meet snakes and lizards up close with a keeper talk.",
          ...
          },
          {
            ...
            uiDescription: "Raptors and parrots demonstrate natural behaviors on cue.",
            location: "Show Arena",
          },
          {
            attractionId: '4',
            ...
            uiDescription: "Hands-on exhibits, climbing nets, and splash pads for families.",
            location: "Kids Zone",
          },
          {
            attractionId: '5',
            ...
            uiDescription: "Walk beneath sharks and rays in a panoramic tunnel.",
            location: "Aquarium",
          },
          {
            attractionId: '6',
            ...
            uiDescription: "Seasonal after-dark path with illuminated animal sculptures.",
            location: "Main Path",
          },
        ]);
      }
  ...
  const visible =
    active === "All"
      ...
      : attractions.filter((a) => {
          ...
          if (active === "Kids" && (desc.includes('kids') || desc.includes('child'))) return true;
          if (active === "Hands-On" && desc.includes('hands-on')) return true;
          if (active === "Shows" && desc.includes('show')) return true;
          if (active === "Tours" && desc.includes('tour')) return true;
          return false;
        });
    ...
    <div className="page attractions-page">
      ...
      <div className="bottom-wrap">
        ...
        <div className="section">
          ...
          {loading ? (
            <div style={{ textAlign: 'center', padding: '2rem' }}>Loading attractions...</div>
          ) : (
              ...
              {visible.map((a) => {
                ...
                const formatHours = (hours) => {
                  if (!hours || !Array.isArray(hours) || hours.length === 0) {
                    return <span className="no-hours">Hours not available</span>;
                  }
                  ...
                  for (const hour of sortedHours) {
                    if (!currentGroup) {
                      currentGroup = { start: hour.dayOfWeek, end: hour.dayOfWeek, open: hour.openTime, close: hour.closeTime };
                    } else if (
                      hour.openTime === currentGroup.open &&
                      hour.closeTime === currentGroup.close &&
                      (dayOrder.indexOf(hour.dayOfWeek) - dayOrder.indexOf(currentGroup.end)) === 1
                    ) {
                ...
                return (
                  <div className="attraction-card two-col" key={a.attractionId}>
                    <div className="media-wrap">
                      <img src={a.uiImage || "/images/attractions/attractions-hero.webp"} alt={a.name} className="attraction-img" />
                    </div>
                    <div className="content-wrap">
                      <div className="eyebrow">{a.location}</div>
                      <h3>{a.name}</h3>
                      <p>{a.uiDescription || a.description}</p>
                      <div className="card-actions">
                      <Link to={`/attractions/${a.attractionId}`} className="text-link" href={`/attractions/${a.attractionId}`}>
                        Learn more →
                      </Link>
                      </div>
                    </div>
