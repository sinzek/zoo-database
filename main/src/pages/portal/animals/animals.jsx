...
export function PortalAnimalsPage() {
  ...
  // Validation: death date cannot be before birth date (only relevant when editing)
  const invalidDates =
    !!editingId &&
    !!formData.birthDate &&
    !!formData.deathDate &&
    new Date(formData.deathDate) < new Date(formData.birthDate);
  ...
  const handleSubmit = async (e) => {
    ...
    // Build base data; only include deathDate if editing (can't set on initial creation)
    const baseData = {
      ...formData,
      imageUrl: formData.imageUrl || null,
    };
    if (!editingId) {
      delete baseData.deathDate; // ensure backend doesn't see an empty deathDate on create
    }
    const animalData = baseData;
  ...
  const resetForm = () => {
    setFormData({
      ...
      genus: "",
      birthDate: "",
      deathDate: "", // kept in state so edit toggle works smoothly
      sex: "male",
      behavior: "",
      habitatId: "",
      importedFrom: "",
            ...
            {animals.map((animal) => (
              <div
                ...
                style={{
                  ...
                  pointerEvents: animal.deletedAt ? "none" : "auto",
                }}
              >
                ...
                <div className="animal-info">
                  ...
                  <p>
                    <strong>Habitat:</strong> {animal.habitatName || "Unknown"}
                  </p>
                  {animal.birthDate && (
                    <p>
                  ...
                  {animal.behavior && (
                    <p>
                      <strong>Behavior:</strong> {animal.behavior}
                    </p>
                  )}
                </div>
                <div
